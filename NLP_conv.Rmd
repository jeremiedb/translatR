...
encode <- conv.graph.encode(input_size = source_input_size, num_embed = num_embed, config = "one-to-one", loss_output = NULL, ignore_label = -1, masking = T, num_hidden = num_hidden, dropout = 0.2, prefix = "encode_", data_name = "data", label_name = "dummy1")
...
#                            wd = 0, clip_gradient = 1, rescale.grad=1)

# optimizer <- mx.opt.create("adadelta", rho = 0.95, epsilon = 1e-6, wd = 0,
#                            clip_gradient = 1, rescale.grad=1)

# lr_scheduler = mx.lr_scheduler.FactorScheduler(step = 1000, factor_val = 0.2, stop_factor_lr = 1e-6, verbose = T)
