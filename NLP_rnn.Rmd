...
mx.model.save(model = model, prefix = "models/model_wmt15_en_fr_rnn_lstm_teacher_v2", iteration = 5)
...
```{r}
model <- mx.model.load(prefix = "models/model_wmt15_en_fr_rnn_lstm_teacher_v2", iteration = 5)
