...
write_rds(preprocess, path = "data/preprocess_euro_en_fr_10_50.rds")
rm(preprocess)
rm(raw_en)
rm(raw_fr)
gc()
...
```{r, eval = FALSE}
preprocess <- read_rds(path = "data/preprocess_euro_en_fr_10_50.rds")
...
write_rds(buckets, "data/buckets_euro_en_fr_10_50.rds")
```
