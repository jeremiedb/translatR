...
query_proj_weight = mx.symbol.Variable("query_proj_weight")
attn_param = list(key = attn_key_value$key, 
                  value = attn_key_value$value, 
                  query_proj_weight = query_proj_weight,
                  scaled = T, 
                  weighting = T, 
                  num_hidden = num_hidden, 
...
system.time(
  model <- mx.model.buckets(symbol = decode,
                            ...
                            metric = mx.metric.Perplexity_offset, 
