...
```{r}
buckets <- read_rds("data/buckets_euro_en_fr_4_24.rds")
...
batch.end.callback <- mx.callback.log.speedometer(batch.size = batch_size, frequency = 10)
