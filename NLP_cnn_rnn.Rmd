...
```{r}
buckets <- read_rds("data/buckets_wmt15_en_fr_8_64_v3.rds")
```
...
mx.model.save(model = model, prefix = "models/model_wmt15_en_fr_cnn_rnn_teacher_v3", iteration = 8)
mx.symbol.save(symbol = decode_argmax, filename = "models/model_wmt15_en_fr_cnn_rnn_argmax_v3.json")
```
...
```{r}
model <- mx.model.load(prefix = "models/model_wmt15_en_fr_cnn_rnn_teacher_v3", iteration = 8)
sym_infer <- mx.symbol.load(file.name = "models/model_wmt15_en_fr_cnn_rnn_argmax_v3.json")
...
```{r}
ctx <- mx.gpu()
bucket_test <- read_rds("data/buckets_wmt14_eval_en_fr_64_v3.rds")
batch_size <- 128
seq_len <- 64
...
write_lines(translation, path = "data/translation/wmt15_en_fr_cnn_rnn_v3.txt")
```
