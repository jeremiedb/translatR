...
mx.model.save(model = model, prefix = "models/model_wmt15_en_fr_cnn_rnn_teacher_v2", iteration = 12)
mx.symbol.save(symbol = decode_argmax, filename = "models/model_wmt15_en_fr_cnn_rnn_argmax_v2.json")
```
